...
/**
 * sfMandangoExtensionPluginClasses.
 *
 * @package sfMandangoPlugin
 * @author  Pablo Díez Pascual <pablodip@gmail.com>
 */
class sfMandangoExtensionPluginClasses extends Extension
{
...
EOF
      ...
      $this->outputs['document_plugin'] = new Output($this->configClass['plugin_dir'].'/lib/model/mandango');
...
EOF
      ...
      $this->outputs['repository_plugin'] = new Output($this->configClass['plugin_dir'].'/lib/model/mandango');
    }
  }
}

 ...
 */
class sfValidatorMandangoChoice extends sfValidatorBase
{
  /**
   * Options:
   *
  ...
  {
    $repository = sfContext::getInstance()->get('Mandango')->getRepository($this->getOption('model'));

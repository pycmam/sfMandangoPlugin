...
/**
 * Panel Web Debug for sfMandango.
 *
 * @package sfMandangoPlugin
 * @author  Pablo Díez Pascual <pablodip@gmail.com>
 */
class sfMandangoWebDebugPanel extends sfWebDebugPanel
{
  /**
   * @see sfWebDebugPanel
   */
  ...
  public function getPanelContent()
  {
    return '
      <div id="sfWebDebugDatabaseLogs">
        <h3>Mandango Version: '.Mandango\Mandango::VERSION.'</h3>
        <ol>'.implode("\n", $this->getLogsList()).'</ol>
      </div>
    ';
  }
  ...
  {
    return sfContext::getInstance()->getConfiguration()->getPluginConfiguration('sfMandangoPlugin')->getLogs();
  }
